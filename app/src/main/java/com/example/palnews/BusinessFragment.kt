...
class BusinessFragment: Fragment(), ShareClicked, ItemClicked {
    ...
    override fun onCreateView(
        ...
        recyclerViewOfBusiness = view.findViewById(R.id.recyclerViewForBusiness)
        newsDataList = ArrayList()

        recyclerViewOfBusiness.layoutManager = LinearLayoutManager(context)

        adapter = NewsAdapter(this,this,newsDataList)
        recyclerViewOfBusiness.adapter = adapter
