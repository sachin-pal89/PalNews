...
class HomeFragment: Fragment(), ItemClicked, ShareClicked {
    ...
    override fun onCreateView(
        ...
        recyclerViewOfHome = view.findViewById(R.id.recyclerViewForHome)
    ...
    private fun findNews(){
        ...
        ApiUtilities.getApiInterface()?.getNews(country,100,api)?.enqueue(object: Callback<MainNewsData>{
