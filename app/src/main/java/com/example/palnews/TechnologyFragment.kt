...
class TechnologyFragment: Fragment(), ItemClicked, ShareClicked {
    ...
    private lateinit var recyclerViewOfTechnology: RecyclerView
    ...
    override fun onCreateView(
        ...
        recyclerViewOfTechnology = view.findViewById(R.id.recyclerViewForTechnology)
        newsDataList = ArrayList()

        recyclerViewOfTechnology.layoutManager = LinearLayoutManager(context)

        adapter = NewsAdapter(this,this,newsDataList)
        recyclerViewOfTechnology.adapter = adapter
